...
def stripe_webhook(request):
    ...
    if settings.DEBUG:
        endpoint_secret= input('Enter the local webook secret generated by Stripe CLI...') #"whsec_9fc3fe3c0a22d70e9d62a1b89b6e0abe158aa5c4c8a769b965c78bf422e7219c"
    else:
...
def manage_vehicle_search_limit(request, max_searches=1):
    ...
    context = {'error': 'You have reached the maximum number of allowed vehicle searches...If you have not created an account, please create one to continue searching.',
