...
from dashboard.views import DashboardDetailView, RepairOrderUpdateView, LineItemUpdateView, LaborItemUpdateView, LineItemCreateWizard,LineItemDeleteView
...
#          chat_sidebar_view, name='dashboard-chats'),
    ...
    path('v2/detail/<int:pk>/lineitems/<int:line_item_id>/delete/',
