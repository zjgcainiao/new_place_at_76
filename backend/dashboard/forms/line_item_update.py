...
class LineItemUpdateForm(AutomanBaseModelForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        created_at_html = '' if not instance or not instance.line_item_created_at else '<p><strong>Created At:</strong> {}</p>'.format(instance.line_item_created_at)
        updated_at_html = '' if not instance or not instance.line_item_last_updated_at else '<p><strong>Last Updated At:</strong> {}</p>'.format(instance.line_item_last_updated_at)
        ...
        self.helper.layout = Layout(
            ...
            Row(
                Column(Field('line_item_description',css_class='form-control'), css_class='col-12 my-1'),
            css_class='form-row p-1 my-1'),
        )