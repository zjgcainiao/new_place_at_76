...
from apis.serializers import CannedJobSerializer
...
class CannedJobViewSet(viewsets.ModelViewSet):
    queryset = CannedJobsNewSQL02Model.objects.order_by('-canned_job_is_in_quick_menu','canned_job_title',).prefetch_related('line_items')

    serializer_class = CannedJobSerializer
