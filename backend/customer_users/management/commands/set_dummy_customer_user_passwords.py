...
class Command(BaseCommand):
    ...
    default_csv_path = '/Users/stephenwang/Documents/myiCloudCopy-76ProLubePlus/13-Information-Technology/003-IT_New-Site-Development-2022/my-development-notes-2023/deployment_toolkits/automatic_scripts/database_related/dummy_user_data/2024_01_16_dummy_customer_user_list.csv'
    ...
    def handle(self, *args, **options):
            ...
            for row in reader:
                ...
                try:
                    with transaction.atomic():
                        ...
                        user, created = CustomerUser.objects.get_or_create(cust_user_email=email)
                        if created:
        ...
        output_file_name = datetime.now().strftime("%y%m%d") + "_affected_customer_users.csv"
        
        # Write affected users to the new CSV file
        with open(output_file_name, 'w', newline='', encoding='utf-8') as csvfile:
            fieldnames = ['email', 'first_name', 'middle_name','last_name','created']
        ...
        self.stdout.write(self.style.SUCCESS(f"Affected customer users have been written to {output_file_name}"))