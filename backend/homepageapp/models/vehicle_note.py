...
class VehicleNotesModel(models.Model):
    ...
    vehicle_note_type = models.CharField(max_length=100,
                                         choices=VEHICLE_NOTE_TYPES,
                                         null=True, blank=True)
    vehicle = models.ForeignKey(
        VehiclesNewSQL02Model, on_delete=models.SET_NULL,
        null=True, blank=True,
        related_name='vehiclenotes_vehicle')
    vehicle_note_text = models.CharField(max_length=400,
                                         null=True, blank=True)
