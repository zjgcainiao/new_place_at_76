...
class NhtsaDecodedVin(models.Model):
    ...
    url = models.URLField(max_length=1500, null=True,
                          blank=True, verbose_name="API URL")
    ...
    created_by = models.ForeignKey(
        InternalUser, on_delete=models.SET_NULL, null=True, related_name='nhtsa_decode_vins_created_by')
    updated_by = models.ForeignKey(
        InternalUser, on_delete=models.SET_NULL, null=True, related_name='nhtsa_decode_vins_updated_by')
