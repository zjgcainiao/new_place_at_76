...
# Path: backend/homepageapp/models/nhtsa_make.py
class NhtsaMake(models.Model):
    id = models.AutoField(primary_key=True)
    make_id = models.IntegerField(unique=True)
    make_name = models.CharField(max_length=500,
                                 db_index=True,
                                 unique=True)
    ...
    created_by = models.ForeignKey(InternalUser, on_delete=models.SET_NULL,
                                   ...
                                   related_name="nhtsa_make_created_by")
    updated_by = models.ForeignKey(InternalUser, on_delete=models.SET_NULL,
                                   null=True, blank=True,
                                   related_name="nhtsa_make_updated_by")
