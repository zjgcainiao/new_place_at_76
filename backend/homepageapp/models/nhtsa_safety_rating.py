...
class NhtsaSafetyRating(models.Model):
    ...
    vehicle_picture_url = models.URLField(
    ...
    front_crash_passengers_side_rating = models.CharField(
        max_length=30, null=True, blank=True)
    front_crash_picture_url = models.URLField(
        max_length=1500, null=True, blank=True)

    front_crash_video_url = models.URLField(
        max_length=1500, null=True, blank=True)
    ...
    side_crash_passengers_side_rating = models.CharField(
        max_length=30, null=True, blank=True)
    side_crash_picture_url = models.URLField(
        max_length=1500, null=True, blank=True)

    side_crash_video_url = models.URLField(
        max_length=1500, null=True, blank=True)
    ...
    side_pole_crash_rating = models.CharField(
        max_length=30, null=True, blank=True)
    side_pole_picture_url = models.URLField(
        max_length=1500, null=True, blank=True)
    side_pole_video_url = models.URLField(
        max_length=1500, null=True, blank=True)
    ...
    rollover_possiblity_2 = models.DecimalField(
        decimal_places=2, max_digits=5, null=True, blank=True)
    ...
    vehicle_id = models.ForeignKey(NhtsaVehicleId, on_delete=models.DO_NOTHING,
                                   null=True, related_name='vehicle_id_nhtsa_safety_ratings')
