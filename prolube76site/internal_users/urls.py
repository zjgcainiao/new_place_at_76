...
from internal_users.views import register, firebase_authenticate, internal_user_login
...
urlpatterns = [
    ...
    path('password_reset/', InternalUserPasswordResetView.as_view(), name='password_reset'),
