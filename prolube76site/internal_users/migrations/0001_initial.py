# Generated by Django 4.1.5 on 2023-04-26 13:44
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_auth_group', models.PositiveSmallIntegerField(choices=[(0, 'Visitor: ready-only'), (2, 'internal-user-group'), (3, 'talent-management-group'), (4, 'accounting-group'), (5, 'it-group'), (6, 'manager-group'), (7, 'boardmember-group'), (8, 'master-shi-fu-group')], default=0)),
